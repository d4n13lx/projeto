...
$sql = $pdo->query("SELECT * FROM news group by id");
$sql->execute();
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
                        ...
                        <ul class="menu_items">
                            ...
                            <li class="submenu"><a class="hover" href="#">Temos que decidir</a>
                                <ul class="items_submenu">
                                    <li class="sub_item"><a class="hover_sub" href="indexRRC.php"> 1</a></li>
                                    <li class="sub_item"><a class="hover_sub" href="indexRRDengue.php">2</a></li>
                            ...
                            <li class="items"><a class="hover" href="noticias.php">Noticias</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="button_acesso_conta">
                    <a href="cadastro.php"><button class="buttons">Cadastro</button></a>
                    <a href=""><button class="buttons">Login</button></a>
                </div>
            </div>
        </div>
    </div>
    <section class="abrigar Noticias">
        <div class="container" >
            <?php foreach ($sql as $v) : ?>
                <section class="grid-column-1-Noticias">
                    <div class="item-1-Noticias">
                        <!-- Aqui ira conter as noticias-->
                        <a href="">
                                <img src="<?php echo $v['img'] ?>" alt="">
                            </a>
                    </div>
                    <div class="grid-row2-Noticias">
                        <a href=""><?php echo $v['titulo'] ?></a>
                        <p><?php echo $v['data'] ?></p>
                    </div>
                    <div class="item-2-Noticias">
                        <div class="item_grid-1-Noticias">
                            <!-- Aqui ira conter outra noticia-->
                            <a href="">
                                <img src="<?php echo $v['img'] ?>" alt="">
                            </a>
                        </div>
                        <div class="item_grid-2-Noticias">
                            <!-- Aqui ira conter outra noticia-->
                            <a href="">
                                <img src="<?php echo $v['img'] ?>" alt="">
                            </a>
                        </div>
                        <div class="item_grid-3-Noticias">
                            <!-- Aqui ira conter outra noticia-->
                            <a href="">
                                <img src="<?php echo $v['img'] ?>" alt="">
                            </a>
                    ...
                    <div class="item-3-Noticias">
                        <div class="grid_3column">
                            <a><?php echo $v['titulo'] ?></a>
                            <p><?php echo $v['data'] ?> </p>
                        </div>
                        <div class="grid_3column2">
                            <a><?php echo $v['titulo'] ?></a>
                            <p><?php echo $v['data'] ?></p>
                        </div>
                        <div class="grid_3column3">
                            <a><?php echo $v['titulo'] ?></a>
                            <p><?php echo $v['data'] ?></p>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="news" >
            <div class="divul">
                ...
                <div class="bt">
                    <h2><?php echo $v['data'] ?></h2>
                </div>
                <div class="bt">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. <br>
                    Tempora sapiente esse ducimus possimus maxime illum maiores,<br>
                    ab laborum dolor veniam exercitationem sunt est delectus.<br>
                    Placeat facilis doloremque nihil assumenda laborum.<br>
                </div>
            </div>
            <div class="divul">
                <h1><?php echo $v['titulo'] ?></h1>
    ...
    <style>
        ...
        .footertwo{
            ...
            justify-content: end;
            border-top: 1px solid #89c53f;
        }
    </style>
    <footer class="abrigar" style="padding:7vh 0 0 0;">
        <div class="container">
            <div class="containerflex">
                <div>
                    <div class="gridcontainer">
                        <div class="guardvirus logo">
                            <a href="home.php"><img style="max-width: 6vw;" src="guardvirus.png"></a>
                        </div>
                        <div class="flex footerdesc descri">
                        ...
                        <div class="footerone" style=" padding:1vh 0 0 0; color:white;border-top: 1px solid #89c53f;">
                                <p>© Guardirus, Inc. 2024. We love our users!</p>    
                        </div>
                        <div class="flex footericons footertwo" style="padding:1vh 0 0 0; color:white; ">
                                <h3>Nos siga:</h3>
