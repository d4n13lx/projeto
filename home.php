                ...
                <div class="menu">
                    <nav>
                        <ul class="menu_items">
                            ...
                            <li class="items"><a class="hover" href="noticia.php">Noticias</a></li>
                        </ul>
                    </nav>
                </div>
            ...
            <div class="containerflex" style="flex-direction:column;">
                ...
                <div class="blocos">
                    <div class="categorias_flex">
                        <h1 class="titulo_blocos">Dengue</h1>
                        <a href="indexCSBR.php" class="blocos_items">
                            <div class="bloco_sub">Mostra a quantidade de casos por bairro de dengue</div>
                    ...
                    <div class="categorias_flex">
                        <h1 class="titulo_blocos">Zika</h1>
                        <a href="" class="blocos_items">
                            <div class="bloco_sub">subtexto</div>
                            <span>Texto aleatorio</span>
                        </a>
                    ...
                    <div class="categorias_flex">
                        <h1 class="titulo_blocos">Chikungunya</h1>
                        <a href="" class="blocos_items">
                            <div class="bloco_sub">subtexto</div>
                            <span>Texto aleatorio</span>
                        </a>
